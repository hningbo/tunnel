...
"""
@author: rylynn 
@file: pcap_reader_sort.py
@time: 2019-07-21 12:30
@discription: 
"""
...
def file_from_pcap(md5, pcap_file, dest_file):
    with PcapReader(pcap_file) as packets:
        ...
        content_temp = {}
        for data in packets:
            if 'UDP' in data and data['UDP'].dport == 40420:
        ...
        for offset in sorted(content_temp):
            dest_file.write(content_temp[offset])
